...
def main():
    ...
    label_method = Label(text="Метод:", bg="#00ffff", anchor='w')
    label_method.place(relx=0, rely=0, relwidth=0.3, relheight=0.04)
    ...
    method_combo = ttk.Combobox(root, state='readonly', values=method_list,
                    font=font_combo)
    method_combo.place(relx=0, rely=0.03, relwidth=0.3, relheight=0.06)
    method_combo.current(0)

    #Задание отрезка
    label_shift = Label(root, text="Отрезок:", anchor='w',
                              bg='#00ffff')
    label_shift.place(relx=0, rely=0.1, relwidth=0.3, relheight=0.04)
    ...
    label_color = Label(root, text="Цвет:", anchor='w',
                              bg='#00ffff')
    label_color.place(relx=0, rely=0.135, relwidth=0.1, relheight=0.06)
    color_combo = ttk.Combobox(root, state='readonly', values=color_list,
                    font=font_combo)
    color_combo.place(relx=0.1, rely=0.135, relwidth=0.2, relheight=0.06)
